...
Write-Host "La imagen de convocatoria-app a sido creada"

Set-Location -Path $rutaCourse
docker build -t "course-app" .
Write-Host "La imagen de course-app a sido creada"

Set-Location -Path $rutaLogin
docker build -t "login-app" .
Write-Host "La imagen de login-app a sido creada"

Set-Location -Path $rutaRegister
docker build -t "register-app" .
Write-Host "La imagen de register-app a sido creada"

Set-Location -Path $rutaRol
docker build -t "rol-app" .
Write-Host "La imagen de rol-app a sido creada"

Set-Location -Path $rutaUsuario
docker build -t "usuario-app" .
Write-Host "La imagen de usuario-app a sido creada"
